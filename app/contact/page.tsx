...
const CONTACT_METHODS = [
  { icon: '✉️', title: '이메일', desc: '평일 기준 1영업일 내 답변', value: 'hello@wegupenglish.com', link: 'mailto:hello@wegupenglish.com' },
  { icon: '💬', title: '카카오톡', desc: '실시간 채팅 상담 가능', value: '@위고업잉글리시', link: 'https://open.kakao.com/' },
  { icon: '📞', title: '운영시간', desc: '전화 상담 예약 가능', value: '평일 09:00 – 18:00', link: null },
]
    ...
    <>
      ...
      <main className="bg-white">
        ...
        <section className="bg-gradient-to-b from-primary-50 to-white py-20 text-center px-6">
          <ScrollReveal>
            <h1 className="text-4xl md:text-5xl font-bold text-primary-900 mb-4">도입 상담 & 문의</h1>
            ...
            <div className="md:col-span-2">
              <ScrollReveal delay={100}>
                ...
                <div className="bg-primary-50 rounded-xl p-5 border border-primary-100">
                  <div className="text-sm font-semibold text-primary-900 mb-2">📋 먼저 무료로 체험해보세요</div>
