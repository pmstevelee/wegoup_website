...
const REVIEWS = [
  {
    ...
    students: '학생 80명',
    duration: '6개월 사용',
    stats: [{ label: '행정시간 절감', value: '65%' }, { label: '학생 만족도', value: '4.8/5' }, { label: '레벨업 달성률', value: '72%' }],
  ...
  },
  {
    ...
    students: '학생 45명',
    duration: '4개월 사용',
    stats: [{ label: '학습 참여율 향상', value: '40%' }, { label: '학부모 만족도', value: '4.9/5' }, { label: '주간 완료율', value: '88%' }],
  ...
  },
  {
    ...
    students: '학생 120명',
    duration: '8개월 사용',
    stats: [{ label: '첨삭 시간 절감', value: '70%' }, { label: '에세이 제출률', value: '94%' }, { label: '평균 레벨 상승', value: '1.8단계' }],
  ...
  },
  {
    ...
    students: '학생 35명',
    duration: '3개월 사용',
    stats: [{ label: '등록 유지율', value: '95%' }, { label: '학생 스트릭 평균', value: '21일' }, { label: '교사 만족도', value: '4.7/5' }],
  ...
  },
  {
    ...
    students: '학생 60명',
    duration: '5개월 사용',
    stats: [{ label: '성적 향상 학생', value: '78%' }, { label: '오답 복습률', value: '91%' }, { label: '수업 준비 시간 절감', value: '50%' }],
    quote: '오답 복습 시스템이 특히 인상적이에요. 학생들이 틀렸던 유형의 문제를 자동으로 다시 풀게 해주는데, 성적 향상이 데이터로 바로 보입니다.',
    author: '원장 정○○',
    avatar: '정',
  ...
  },
  {
    ...
    students: '학생 95명',
    duration: '7개월 사용',
    stats: [{ label: '신규 등록 증가', value: '25%' }, { label: '학부모 재등록률', value: '89%' }, { label: '교사 이직률 감소', value: '60%' }],
    quote: '도입 후 가장 크게 달라진 것은 선생님들의 업무 만족도입니다. 행정 업무가 줄고 교육에 집중할 수 있게 되면서 선생님들이 더 오래 함께하고 싶어합니다.',
    author: '원장 강○○',
    avatar: '강',
    ...
    <>
      ...
      <main className="bg-white">
        ...
        <section className="bg-gradient-to-b from-primary-50 to-white py-20 text-center px-6">
          <ScrollReveal>
            <h1 className="text-4xl md:text-5xl font-bold text-primary-900 mb-4">실제 학원의 실제 변화</h1>
            <p className="text-lg text-gray-600 max-w-xl mx-auto">전국 영어학원이 위고업잉글리시로 어떻게 달라졌는지 확인해보세요.</p>
          </ScrollReveal>
        </section>
              ...
              <ScrollReveal key={review.academy} delay={i * 80}>
                <div className="border border-gray-200 rounded-2xl p-6 flex flex-col h-full hover:shadow-sm transition-all">
                  <div className="flex items-center gap-3 mb-4">
                    <div className={`w-10 h-10 rounded-xl ${review.avatarBg} flex items-center justify-center font-bold text-sm flex-shrink-0`}>
                      {review.avatar}
                    </div>
                    <div>
